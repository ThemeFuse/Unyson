jQuery(document).ready(function ($) {
				...
				.on('click', '.fw-option-box-control', function(e){
					...
					switch (controlId) {
						...
						default:
							...
							$control.closest('.fw-option-type-addable-box').trigger(
	...
	fwEvents.on('fw:options:init', function (data) {
		var $elements = data.$elements.find('.fw-option-type-addable-box:not(.fw-option-initialized)');

		/** Init Add button */
		$elements.on('click', '.fw-option-boxes-controls .fw-option-boxes-add-button', function(){
			var $button   = $(this);
			var $option   = $button.closest('.fw-option-type-addable-box');
